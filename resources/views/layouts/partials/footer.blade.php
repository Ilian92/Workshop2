        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                <div class="flex items-center mb-4">
                    <span class="text-2xl font-bold text-green-400">APWAP</span>
                </div>
                <p class="text-gray-300 mb-4">
                    Votre boutique en ligne dédiée au bien-être de vos animaux. 
                    Découvrez notre sélection de produits de qualité pour chiens, chats et autres compagnons.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ route('dashboard') }}" class="text-gray-300 hover:text-white">Accueil</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-300">
                    <li>📧 contact@apwap.fr</li>
                    <li>📞 +33 1 23 45 67 89</li>
                    <li>📍 123 rue des Animaux, 75000 Paris</li>
                </ul>
            </div>
        </div>

        <div class="mt-8 pt-8 border-t border-gray-700 text-center text-gray-300">
            <p>&copy; {{ date('Y') }} APWAP. Tous droits réservés.</p>
        </div>
    </div>
</footer>
