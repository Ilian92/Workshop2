<x-layout title="Edit Animal">
    <div class="container mx-auto px-4 py-8">
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Edit {{ $animal->nom }}</h1>
                    <p class="text-gray-600 mt-2">Update your pet's information</p>
                </div>
                <a href="{{ route('animals.index') }}" class="text-primary-600 hover:text-primary-800 flex items-center">
                    ...
                    <form action="{{ route('animals.update', $animal) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="nom" name="nom" value="{{ old('nom', $animal->nom) }}" 
                            ...
                            <div>
                                ...
                                <input type="date" id="dateNaissance" name="dateNaissance" value="{{ old('dateNaissance', $animal->dateNaissance) }}" 
                                       max="{{ date('Y-m-d') }}"
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="caractere" name="caractere" rows="4"
                                      ...
                                      placeholder="Describe your pet's personality, temperament, and behavior...">{{ old('caractere', $animal->caractere) }}</textarea>
                            @error('caractere')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
