<x-layout>
    <form method="POST" action="{{ route('register') }}" class="container">
        ...
        <div class="mt-4">
            ...
            <textarea id="address" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" name="address" required autocomplete="address-line1">{{ old('address') }}</textarea>
